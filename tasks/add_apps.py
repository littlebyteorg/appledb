...
while True:
    ...
    if os_str in ['Apple TV', 'Apple Business', 'Apple Business Essentials', 'Apple Music Classical', 'Apple Partner Media Review', 'iCloud Bookmarks', 'iCloud Passwords', 'GarageBand', 'Photomator', 'Connect SSO', 'Sneaky Sasquatch', 'MainStage', 'Shazam', 'Numbers', 'Pages', 'Keynote', 'Final Cut Pro', 'Logic Pro', 'Compressor', 'Motion', 'Pixelmator Pro', 'iMovie', 'Apple Immersive Video Utility']:
        os_str = app_name
    app_details = {
        'osStr': os_str,
        'version': version,
