...
while True:
    ...
    if os_str in ['Apple TV', 'Apple Music Classical', 'iCloud Bookmarks', 'iCloud Passwords', 'GarageBand', 'Photomator', 'Connect SSO', 'Sneaky Sasquatch', 'Shazam', 'Numbers', 'Pages', 'Keynote', 'Final Cut Pro', 'Logic Pro', 'Compressor', 'Motion', 'Pixelmator Pro', 'iMovie']:
        os_str = app_name
    app_details = {
        'osStr': os_str,
        'version': version,
