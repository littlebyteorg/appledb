...
info_key_order = {
    ...
    "Connectivity": ["type", "Concurrent Devices", "Data Throughput", "Frequency", "Interfaces", "MiMO", "Security", "Ports", "Cellular", "Supports", "Notes", "External_Display_Count", "Wi-Fi", "Bluetooth", "Power_Adapter", "Ultra-wideband"],
    "CPU, RAM & Storage": ["type", "CPU", "Flash Memory", "RAM"],
