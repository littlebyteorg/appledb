module.exports = {
  ...
  info: {
    ...
    notes: "iOS 14.4 - 14.5.1 support is only available on A12+ devices with Fugu14 (Betas are not supported). iOS 14.6 to 14.8 support only available on A12 and A13 iPhones. TrollStore method requires an A12+ device.",
